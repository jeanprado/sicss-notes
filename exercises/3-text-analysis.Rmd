...
antes até de começar o pré-processamento, vou remover os links do texto dos tweets. [da primeira vez](https://github.com/jeanprado/sicss-notes/commit/fe9f5ba50b954de0c1b7552b49187637f4a58a11) não fiz isso e em algumas partes da análise apareceu uma sequência de aleatório, como `dj1398d928`, que era o final das URLs. mais fácil remover esse tipo de coisa antes de tokenizar o texto (quebrar em palavras únicas).

para remover as URLs do texto, usei uma [regex](https://pt.wikipedia.org/wiki/Express%C3%A3o_regular) que copiei dessa thread no stack overflow. (ninguém é de ferro, né?)
